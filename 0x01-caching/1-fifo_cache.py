...
class FIFOCache(BaseCaching):
    ...
    def __init__(self):
        """
        Initialize the cache and the order list to maintain the insertion order of keys.
        """
        super().__init__()
        self.order = []
    ...
    def put(self, key, item):
        ...
        If the cache exceeds the MAX_ITEMS limit, the oldest entry (first added) is discarded.
        Args:
